// src/hooks/useBillingStore.js
// ─────────────────────────────────────────────────────────────────────────────
// Central billing state + the critical cascade discharge function.
// The processDischarge() function is the key piece — it atomically:
//   1. Marks invoice as paid
//   2. Sets patient status → "Discharged"
//   3. Frees the bed → "empty"
//   4. Decrements doctor patient count → restores "Available"
// ─────────────────────────────────────────────────────────────────────────────
...
export function useBillingStore() {
  ...
  return {
    ...
    createInvoice, processDischarge, waiveInvoice,
  };
}