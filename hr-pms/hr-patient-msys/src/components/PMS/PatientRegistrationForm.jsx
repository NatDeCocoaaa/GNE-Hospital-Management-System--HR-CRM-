// src/components/PMS/PatientRegistrationForm.jsx
...
const VISIT_TYPE_META = {
  ...
  "Emergency":   { icon: Heart,        color: "text-danger-600",   bg: "bg-danger-50",    border: "border-danger-300",    desc: "Urgent medical need" },
  "Referral":    { icon: ClipboardList,color: "text-violet-600",   bg: "bg-violet-50",    border: "border-violet-300",    desc: "Doctor referral" },
};
...
export default function PatientRegistrationForm({ onClose, onRegister }) {
