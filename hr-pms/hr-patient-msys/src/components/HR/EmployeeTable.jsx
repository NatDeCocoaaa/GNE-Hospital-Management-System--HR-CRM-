// src/components/HR/EmployeeTable.jsx
...
import { DEPARTMENTS, STATUS_COLORS, ROLE_COLORS } from "../src/data/hrData";
...
function Avatar({ row }) {
  ...
  const bg = colors[emp.id.charCodeAt(1) % colors.length];
  return (
...
// ── Main EmployeeTable ─────────────────────────────────────────────────────────
export default function EmployeeTable({ employees, onAdd, onEdit, onDelete, onStatusChange }) {
